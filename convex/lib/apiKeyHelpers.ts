/**
 * Pure, dependency-free API-key helpers (Convex-side copy).
 *
 * SYNC: this is a byte-for-byte copy of the logic in src/lib/apiKeys.ts
 * (Convex cannot import from src/). Keep both in sync.
 *
